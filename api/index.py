...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "11AC4"  # Playfab Title Id
        self.SecretKey: str = "I1GKRGDM8ZCF1O3IEFQHXZ77IIJOI81WOU4JQPNHA6YQD845JS"  # Playfab Secret Key
        self.ApiKey: str = "OC|1220510291146154|848b8f4d5671499ab735fe83a7b7b2fa"  # App Api Key (Oculus/Graph API)
...
def titledata():
    response_data = {
        ...
        "MOTD": "<color=#FFC0CB>WELCOME TO COOL TAG!</color>\n\n<color=#0099c2>CURRENT UPDATE: SCIENCE24</color>\n<color=#cacfd2>OWNERS: ZENON, PAUL THE PENGUIN, ADR</color>\n<color=#41ff80>ZENON MADE THIS MOTD</color>\n<color=#6417ff>OUR DEVELOPERS ARE: ZENON</color>\n<color=#ac1a00>tuff</color>\n\n<color=#91A3B0>U A FEMBOY</color>",
